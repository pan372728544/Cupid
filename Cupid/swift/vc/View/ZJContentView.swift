...
@objc protocol ZJContentViewDelegate : class {
    func contentView(_ contentView : ZJContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : ZJContentView)
}

private let kContentCellID = "kContentCellID"

class ZJContentView: UIView {
    
    // MARK: 对外属性
    weak var delegate : ZJContentViewDelegate?
...
extension ZJContentView : UICollectionViewDataSource {
...
extension ZJContentView : UICollectionViewDelegate {
