...
// MARK:- 定义协议
protocol ZJTitleViewDelegate : class {
    func titleView(_ titleView : ZJTitleView, selectedIndex index : Int)
}

class ZJTitleView: UIView {
    
    // MARK: 对外属性
    weak var delegate : ZJTitleViewDelegate?
    ...
    // MARK: 自定义构造函数
    init(frame: CGRect, titles : [String], style : ZJTitleStyle) {
