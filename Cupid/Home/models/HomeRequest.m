...
+(NSDictionary *)getCommonParamDic
{
    ...
    NSString *time = [self getNowTime];
       ...
       NSDictionary *dic =@{
                             ...
                             @"vid":@"B3DD620A-6EFA-4961-A418-C30D1FD7DA3F",
                             @"device_id":@"51323627722",
                             @"channel":@"App Store",
                             ...
                             @"openudid":@"5326e05065bd38f79fc442f83ac49b30463c6368",
                             @"update_version_code":@"70614",
                             @"idfv":@"B3DD620A-6EFA-4961-A418-C30D1FD7DA3F",
                             @"ac":@"WIFI",
                             @"os_version":@"12.0",
                             @"ssmix":@"a",
