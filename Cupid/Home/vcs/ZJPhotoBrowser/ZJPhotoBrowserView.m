...
@interface ZJPhotoBrowserView() <UIScrollViewDelegate>
@property (nonatomic,strong) ZJIndicatorView *indicatorView;
...
@implementation ZJPhotoBrowserView
...
//{
//
//CGFloat  f=    [recognize translationInView:self].y;
//
//    MYLog(@"%f     ",f);
//
//
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    ZJIndicatorView *indicatorView = [[ZJIndicatorView alloc] init];
    indicatorView.viewMode = ZJIndicatorViewModeLoopDiagram;
